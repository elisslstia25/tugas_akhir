                ...
                <div class="card">
                     <div class="card-header bg-primary">
                        <div class="card-title">
                            <h4>Data Laporan Kemajuan Penelitian</h4>
                        </div>
                     </div>
                     <div class="card-body">
                        <div class="container">
                            <table id="table1" class="table table-bordered table-striped">
                                ...
                                @endphp
                                <tbody>
                                    @foreach ($list_berjalan as $dosen__penelitian_usulanbaru)
                                    @if ($dosen__penelitian_usulanbaru->status == 2)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ url('dosen/berjalan/create', $dosen__penelitian_usulanbaru) }}"
